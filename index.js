...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ Hello, NOVA-XMD Legend! ✨*

╭─〔 *🤖 NOVA-XMD BOT* 〕  
├─▸ *Simplicity. Speed. Power. BY NOVA XMD |*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️ Thank you for Choosing NOVA-XMD!*

╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029Vad7YNyJuyA77CtIPX0x) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/novaxmd/NOVA-XMD)!  
╰─🛠️ *Prefix:* \`${prefix}\`
...
> _© MADE BY 𝘕𝘖𝘝𝘈 𝘟𝘔𝘋_`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('255767862457', '255741752020', '255711782669');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("255741752020")){
  if(isReact) return
  m.react("🌚")
   }
  //==========public react============//
